export default function BranchBreakdown({ stats }) {
    ...
    return (
        <div className="card fade-in" style={{ flex: '1 1 auto', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            <div className="card-header" style={{ flexShrink: 0 }}>
                <span className="card-title">Branch Breakdown</span>
            </div>
            <div className="branch-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)', overflowY: 'auto', flex: 1, paddingBottom: 12 }}>
